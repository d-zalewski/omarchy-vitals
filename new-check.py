...
MODULES = {
    ...
    "kernel_features": "tier 1 — namespaces, seccomp, cgroups, KVM",
    "filesystem": "tier 1 — round-trip, btrfs health, swap, discard",
...
TEST_FILE = {
    ...
    "kernel_features": "test_checks_kernel_features.py",
    "filesystem": "test_checks_filesystem.py",
