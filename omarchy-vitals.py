...
from vitals.checks import (audio, graphics, health, kernel_build,  # noqa: E402,F401
                          latency, network, peripherals, stress,
                          throughput)

TIER_NAMES = {
    0: "health           (kernel faults, taint, failed units)",
    1: "desktop hardware (gpu, audio, network, peripherals, toolchain)",
