...
| 1 | hardware: GPU, audio, network, USB, input, storage, thermal, module loading, DKMS, driver binding, TPM and LUKS unlock | 4m |
...
332 tests, 100 % coverage, no hardware or network access — they run anywhere in
under a second.
